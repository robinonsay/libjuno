...
/**
    Multiply scalar with vec2f's
*/
static inline JUNO_VEC2_F32_T Juno_Vec2_f32_Mult(JUNO_VEC2_F32_T tVec0, double dScalar)
{
    tVec0.arr[0] *= dScalar;
    tVec0.arr[1] *= dScalar;
    return tVec0;
...
/**
    Dot product of two vec2f's
*/
static inline double Juno_Vec2_f32_Dot(JUNO_VEC2_F32_T tVec0, JUNO_VEC2_F32_T tVec1)
{
    return tVec0.arr[0] * tVec1.arr[0] + tVec0.arr[1] * tVec1.arr[1];
}
...
/**
    ...
    The result is a psedoscalar
*/
static inline double Juno_Vec2_f32_Cross(JUNO_VEC2_F32_T tVec0, JUNO_VEC2_F32_T tVec1)
{
    return tVec0.arr[0] * tVec1.arr[1] - tVec0.arr[1] * tVec1.arr[0];
}
...
/**
    Multiply scalar with vec2f's
*/
static inline JUNO_VEC3_F32_T Juno_Vec3_f32_Mult(JUNO_VEC3_F32_T tVec0, double dScalar)
{
    tVec0.arr[0] *= dScalar;
    tVec0.arr[1] *= dScalar;
    tVec0.arr[2] *= dScalar;
...
/**
    Dot product of two vec2f's
*/
static inline double Juno_Vec3_f32_Dot(JUNO_VEC3_F32_T tVec0, JUNO_VEC3_F32_T tVec1)
{
    return tVec0.arr[0] * tVec1.arr[0] + tVec0.arr[1] * tVec1.arr[1] + tVec0.arr[2] * tVec1.arr[2];
}
