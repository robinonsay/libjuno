...
| Test Case ID | Pattern | Scenario | Strategy | Requirement |
|-------------|---------|----------|----------|-------------|
| TC-P1-001 | P1 | JUNO_LOG_ROOT_TAG, JUNO_MODULE_EMPTY | — | REQ-VSCODE-008 |
| TC-P1-002 | P1 | JUNO_DS_HEAP_ROOT_TAG, extra members | — | REQ-VSCODE-008 |
| TC-P1-003 | P1 | JUNO_SB_BROKER_ROOT_TAG | — | REQ-VSCODE-008 |
| TC-P1-004 | P1 | Negative: JUNO_MODULE_DERIVE | — | REQ-VSCODE-008 |
| TC-P2-001 | P2 | ENGINE_APP_TAG derives JUNO_APP_ROOT_T | — | REQ-VSCODE-009 |
| TC-P2-002 | P2 | JUNO_SB_PIPE_TAG derives JUNO_DS_QUEUE_ROOT_T | — | REQ-VSCODE-009 |
| TC-P2-003 | P2 | Negative: JUNO_MODULE_ROOT | — | REQ-VSCODE-009 |
| TC-P3-001 | P3 | JUNO_POINTER_TAG, JUNO_TRAIT_ROOT | — | REQ-VSCODE-014 |
| TC-P3-002 | P3 | Negative: JUNO_MODULE_ROOT | — | REQ-VSCODE-014 |
| TC-P3-003 | P3 | Negative: JUNO_MODULE_DERIVE | — | REQ-VSCODE-014 |
| TC-P4-001 | P4 | MY_POINTER_IMPL_TAG, JUNO_TRAIT_DERIVE (synthetic) | — | REQ-VSCODE-015 |
| TC-P4-002 | P4 | Negative: JUNO_TRAIT_ROOT (synthetic) | — | REQ-VSCODE-015 |
| TC-P5-001 | P5 | JUNO_DS_HEAP_API_T: [Insert, Heapify, Pop] | — | REQ-VSCODE-012 |
| TC-P5-002 | P5 | JUNO_LOG_API_T: [LogDebug, LogInfo, LogWarning, LogError] | — | REQ-VSCODE-012 |
| TC-P5-003 | P5 | JUNO_DS_HEAP_POINTER_API_T: [Compare, Swap] | — | REQ-VSCODE-012 |
| TC-P5-004 | P5 | JUNO_POINTER_API_T: [Copy, Reset] | — | REQ-VSCODE-012 |
| TC-P5-005 | P5 | JUNO_SB_BROKER_API_T: [Publish, RegisterSubscriber] | — | REQ-VSCODE-012 |
| TC-P6-001 | P6 | Designated: tEngineAppApi (OnStart, OnProcess, OnExit) | — | REQ-VSCODE-010 |
| TC-P6-002 | P6 | Negative: positional initializer → zero designated matches | — | REQ-VSCODE-010 |
| TC-P6-003 | P6 | Negative: non-API-T type variable | — | REQ-VSCODE-010 |
| TC-P7-001 | P7 | Direct assignment tHeapApi.Insert (synthetic) | — | REQ-VSCODE-011 |
| TC-P7-002 | P7 | Disambiguation vs P6 (synthetic) | — | REQ-VSCODE-011 |
| TC-P8-001 | P8 | Positional: JUNO_DS_HEAP_API_T, juno_heap.c | — | REQ-VSCODE-012 |
| TC-P8-002 | P8 | Positional: JUNO_SB_BROKER_API_T, static functions | — | REQ-VSCODE-012 |
| TC-P8-003 | P8 | Positional: JUNO_LOG_API_T, main.c | — | REQ-VSCODE-012 |
| TC-P8-004 | P8 | Negative: designated initializer → no fallthrough to P8 | — | REQ-VSCODE-012 |
| TC-P9-001 | P9 Ph1 | Phase 1: Now, cursor confirmed | — | REQ-VSCODE-003 |
| TC-P9-002 | P9 Ph1 | Phase 1: LogInfo via indirect variable | — | REQ-VSCODE-003 |
| TC-P9-003 | P9 Ph1 | Negative: plain member access, no `(` | — | REQ-VSCODE-003 |
| TC-P9-004 | P9 Ph1 | Negative: cursor on whitespace | — | REQ-VSCODE-003 |
| TC-P9-005 | P9 Ph1 | Negative: free function call | — | REQ-VSCODE-003 |
| TC-P9-101 | P9 A | Simple pointer: ptTime->ptApi->Now | A | REQ-VSCODE-003 |
| TC-P9-102 | P9 A | Simple pointer: ptBroker->ptApi->Publish | A | REQ-VSCODE-003 |
| TC-P9-103 | P9 A | Array subscript: ptAppList[i]->ptApi->OnStart | A | REQ-VSCODE-003 |
| TC-P9-104 | P9 A | Array subscript (var index): ptAppList[iCounter]->ptApi->OnProcess | A | REQ-VSCODE-003 |
| TC-P9-105 | P9 A | Chained member: ptEngineApp->ptBroker->ptApi->RegisterSubscriber | A | REQ-VSCODE-003 |
| TC-P9-201 | P9 A | Dot-accessed: tReturn.ptApi->Copy | A | REQ-VSCODE-003 |
| TC-P9-202 | P9 A | Nested dot: tPtrResult.tOk.ptApi->Copy | A | REQ-VSCODE-003 |
| TC-P9-203 | P9 A | Dot-accessed: tItem.ptApi->Copy | A | REQ-VSCODE-003 |
| TC-P9-301 | P9 C | Indirect: ptLoggerApi->LogInfo | C | REQ-VSCODE-003 |
| TC-P9-302 | P9 C | Indirect: ptCmdPipeApi->Dequeue | C | REQ-VSCODE-003 |
| TC-P9-303 | P9 C | Indirect: ptApi->GetAt (generic name) | C | REQ-VSCODE-003 |
| TC-P9-401 | P9 B | Non-ptApi member: ptHeapPointerApi->Compare | B | REQ-VSCODE-003 |
| TC-P9-402 | P9 B | Non-ptApi member: ptHeapPointerApi->Swap | B | REQ-VSCODE-003 |
| TC-P9-501 | P9 D | Macro: JUNO_MODULE_GET_API()->Insert (synthetic) | D | REQ-VSCODE-003 |
| TC-P9-601 | P9 E | Fallback: unknown receiver, unique field | E | REQ-VSCODE-003 |
| TC-P9-602 | P9 E | Fallback: unknown receiver, shared field name | E | REQ-VSCODE-003,006 |
| TC-P9-603 | P9 E | Fallback: unknown field → not found | E | REQ-VSCODE-003,004 |
| TC-P10-001 | P10 | Direct: ptHeap->_pfcnFailureHandler | — | REQ-VSCODE-016 |
| TC-P10-002 | P10 | Macro form: JUNO_FAILURE_HANDLER (gap in P10 regex) | — | REQ-VSCODE-016 |
| TC-P10-003 | P10 | Negative: ptApi assignment | — | REQ-VSCODE-016 |
| TC-P11-001 | P11 | Match: static LogInfo (varied return type) | — | REQ-VSCODE-003 |
| TC-P11-002 | P11 | Match: non-static JunoDs_Heap_Insert | — | REQ-VSCODE-003 |
| TC-P11-003 | P11 | Allman braces gap: static inline Verify | — | REQ-VSCODE-003 |
| TC-P11-004 | P11 | Match: void FailureHandler | — | REQ-VSCODE-003 |
| TC-P11-005 | P11 | Match: static result-type Now | — | REQ-VSCODE-003 |
| TC-P11-006 | P11 | No match: forward declaration (`;`) | — | REQ-VSCODE-003 |
| TC-P11-007 | P11 | No match: header prototype (`;`) | — | REQ-VSCODE-003 |
| TC-RES-001 | E2E | LogInfo via indirect API pointer (Strategy C) | C | REQ-VSCODE-005 |
| TC-RES-002 | E2E | OnStart via array subscript (Strategy A + QuickPick) | A | REQ-VSCODE-006 |
| TC-RES-003 | E2E | RegisterSubscriber via chained member (Strategy A) | A | REQ-VSCODE-005 |
| TC-RES-004 | E2E | Compare via non-ptApi member (Strategy B) | B | REQ-VSCODE-005 |
| TC-RES-005 | E2E | Copy via dot-accessed ptApi (Strategy A, dot form) | A | REQ-VSCODE-005 |
| TC-RES-006 | E2E | No implementation found — error path | E | REQ-VSCODE-004,013 |
| TC-RES-007 | E2E | Multiple implementations — QuickPick | A | REQ-VSCODE-006 |
...
2. **P9 line scanning:** For tests involving backward type scans (Strategy A, C), provide the relevant
   source file text as a string parameter — do not read actual files in unit tests. Parameterise the
   resolver's source-text getter.

3. **TC-P11-003 (Allman braces):** Write the test expecting NO match from the current single-line
   regex, then separately write an integration-level test verifying the implementation handles
   Allman style via whatever extension mechanism is chosen.

4. **TC-P10-002 (macro form):** Write the test expecting `null` / no match from P10 as-specified,
   then add a failing test that asserts the desired behavior (`match found`) as a reminder that
   the gap must be closed before REQ-VSCODE-016 is fully satisfied.
...
6. **Order of strategy execution:** For TC-P9-303, write an explicit test asserting that Strategy A
   does NOT fire when `ptApi` is the variable name (no preceding `->` or `.`) and that Strategy C
   fires instead. This prevents a regression where both strategies could claim the same call site.
...
including the gap identified in TC-P10-002 for the `JUNO_FAILURE_HANDLER` macro form.
...
**Setup:**
- This test asserts the DESIRED behavior after closing the design gap identified in TC-P10-002.
- Index state:
  ```typescript
  failureHandlerAssignments: {
    "JUNO_APP_ROOT_T": [
...
| TC-P9-004 | P9 Ph1 | Negative: cursor on whitespace | REQ-VSCODE-003 |
| TC-P9-005 | P9 Ph1 | Negative: free function call | REQ-VSCODE-003 |
| TC-P9-101 | P9 A | Simple pointer: ptTime->ptApi->Now | REQ-VSCODE-003 |
| TC-P9-102 | P9 A | Simple pointer: ptBroker->ptApi->Publish | REQ-VSCODE-003 |
| TC-P9-103 | P9 A | Array subscript: ptAppList[i]->ptApi->OnStart | REQ-VSCODE-003 |
| TC-P9-104 | P9 A | Array subscript (var index): ptAppList[iCounter]->ptApi->OnProcess | REQ-VSCODE-003 |
| TC-P9-105 | P9 A | Chained member: ptEngineApp->ptBroker->ptApi->RegisterSubscriber | REQ-VSCODE-003 |
| TC-P9-201 | P9 A | Dot-accessed: tReturn.ptApi->Copy | REQ-VSCODE-003 |
| TC-P9-202 | P9 A | Nested dot: tPtrResult.tOk.ptApi->Copy | REQ-VSCODE-003 |
| TC-P9-203 | P9 A | Dot-accessed: tItem.ptApi->Copy | REQ-VSCODE-003 |
| TC-P9-301 | P9 C | Indirect: ptLoggerApi->LogInfo | REQ-VSCODE-003 |
| TC-P9-302 | P9 C | Indirect: ptCmdPipeApi->Dequeue | REQ-VSCODE-003 |
| TC-P9-303 | P9 C | Indirect: ptApi->GetAt (generic name) | REQ-VSCODE-003 |
| TC-P9-401 | P9 B | Non-ptApi member: ptHeapPointerApi->Compare | REQ-VSCODE-003 |
| TC-P9-402 | P9 B | Non-ptApi member: ptHeapPointerApi->Swap | REQ-VSCODE-003 |
| TC-P9-501 | P9 D | Macro: JUNO_MODULE_GET_API()->Insert (synthetic) | REQ-VSCODE-003 |
| TC-P9-601 | P9 E | Fallback: unknown receiver, unique field | REQ-VSCODE-003 |
| TC-P9-602 | P9 E | Fallback: unknown receiver, shared field name | REQ-VSCODE-003, REQ-VSCODE-006 |
| TC-P9-603 | P9 E | Fallback: unknown field → not found | REQ-VSCODE-003, REQ-VSCODE-004 |
| TC-P10-001 | P10 | Direct: ptHeap->_pfcnFailureHandler | REQ-VSCODE-016 |
| TC-P10-002 | P10 | Macro form: JUNO_FAILURE_HANDLER (gap in P10 regex) | REQ-VSCODE-016 |
| TC-P10-003 | P10 | Negative: ptApi assignment | REQ-VSCODE-016 |
| TC-P11-001 | P11 | Match: static LogInfo (varied return type) | REQ-VSCODE-003 |
...
| TC-P11-006 | P11 | No match: forward declaration (`;`) | REQ-VSCODE-003 |
| TC-P11-007 | P11 | No match: header prototype (`;`) | REQ-VSCODE-003 |
| TC-RES-001 | E2E | LogInfo via indirect API pointer (Strategy C) | REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-RES-002 | E2E | OnStart via array subscript (Strategy A + QuickPick) | REQ-VSCODE-003, REQ-VSCODE-006 |
| TC-RES-003 | E2E | RegisterSubscriber via chained member (Strategy A) | REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-RES-004 | E2E | Compare via non-ptApi member (Strategy B) | REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-RES-005 | E2E | Copy via dot-accessed ptApi (Strategy A, dot form) | REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-RES-006 | E2E | No implementation found — error path | REQ-VSCODE-004, REQ-VSCODE-013 |
| TC-RES-007 | E2E | Multiple implementations — QuickPick | REQ-VSCODE-006 |
...
| TC-SYS-001 | System E2E | LogInfo via indirect API pointer — real file, Strategy C | REQ-VSCODE-002, REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-SYS-002 | System E2E | RegisterSubscriber via chained member access — real file, Strategy A | REQ-VSCODE-002, REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-SYS-003 | System E2E | Now via standard ptApi access — real file, Strategy A | REQ-VSCODE-002, REQ-VSCODE-003, REQ-VSCODE-005 |
| TC-SYS-004 | System E2E | Publish via standard ptApi access — real file, Strategy A | REQ-VSCODE-002, REQ-VSCODE-003, REQ-VSCODE-005 |
...
| REQ-VSCODE-003 | LibJuno API Pattern Recognition | TC-P9-001 through TC-P9-603, TC-P11-001 through TC-P11-007, TC-RES-001 through TC-RES-007, TC-SYS-001 through TC-SYS-007, TC-SYS-009, TC-SYS-010, TC-SYS-013, TC-SYS-014 |
...
| REQ-VSCODE-009 | Module Derivation Chain Resolution | TC-P2-001 through TC-P2-003 |
...
| REQ-VSCODE-016 | Failure Handler Navigation | TC-P10-001 through TC-P10-003, TC-FH-001 through TC-FH-004, TC-SYS-008 |
